...
race_model = DT(r"C:\Users\agboo\dT_model\bcbs_risk.csv")

r = race_model.model_creation()


bmi_model = DT(r"C:\Users\agboo\dT_model\bcbs_risk.csv" , fit_race = False)

b = bmi_model.model_creation()

# testing

final1 = Test(path = r"C:\Users\agboo\dT_model\Logr_backtest.csv" , model = r)

final1.test(model = r)

final2 = Test(path = r"C:\Users\agboo\dT_model\Logr_backtest.csv" , model = b , fit_race = False)
